...
Hmm, ..., let's figure it out ASAP.

{/* While the va */}

... reserve and sending messages are both executed in the action phase ...

And the case with send remaining functions...

Also, link all functions from the reference to this explanation
