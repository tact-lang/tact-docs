...
Conversion of `get`-methods arguments is straightforward. Each argument is mapped as-is to FunC one, and each tuple is mapped to a [Struct](/book/composite-types#structs).
