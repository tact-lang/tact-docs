...
<Callout type="error" emoji="🚨">
  Currently circular **types** are not possible. Meaning that struct/message
  **A** can't have field of a struct/message **B** that have field of a
  struct/message **A**.
</Callout>
...
<Callout type="info" emoji="📚️">
  More examples of using the `map` methods can be found
  [here](https://tact-by-example.org/04-maps).
</Callout>
