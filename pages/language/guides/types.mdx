...
contract HelloWorld {
  ...
  counters_2: map<Address, Int>; // ✅
  counters_3: map<Bool, Int>;  // ❌
}
```

More details can check:
https://tact-by-example.org/04-maps
...
More usage and examples can check:
https://tact-by-example.org/01-the-deployable-trait
