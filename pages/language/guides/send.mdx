...
The simplest message is a reply to the incoming message by returning all excess value of a message:
...
To send a binary typed message you can use the next code:
