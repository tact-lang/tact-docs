...
Virtual constants is the constracts that could be defined in trait, but changed in contract. It is useful when you need to configure some of the traits in compile time. Let's define a virtual constant and an abstract one:
