...
After you accept the gas, the contract can use as much gas as it wants. This is done to allow the contract to carry out any kind of processing. You should always test the gas usage of your contracts verify that everything is working as intended, and avoid possible vulnerabilities that could drain the contract balance.
