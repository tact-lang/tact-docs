...
Tact has a first-class support for Jest and `ton-emulator` for contract tests and debugging. Prefered type of tests are the one with inline snapwshots. They are easy to write and easy to debug.
