...
[@stdlib/content][2]   | Encoding off-chain link strings to a [Cell][cell].            | `createOffchainContent`
[@stdlib/deploy][3]    | Unified mechanism for deployments.                            | `Deployable`, `FactoryDeployable`
[@stdlib/dns][4]       | Resolution of DNS names.                                      | `DNSResolver`, `dnsInternalVerify`
