...
receive("send") {
    ...
    send(SendParameters{
        ...
        body: JettonTransfer{
            ...
            customPayload: null, // in most cases will be null and can be omited. Needed for custom logic on Jetton Wallets itself
            forwardTonAmount: 1, // amount that will be transferred with JettonTransferNotification. Needed for custom logic execution like in example below. If the amount is 0 notification won't be sennt
