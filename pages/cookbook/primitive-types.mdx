...
<Callout type="info" emoji="🤔">
  ...
  Didn't find your favorite example of working with primitive types? Have cool implementations in mind? [Contributions are welcome!](https://github.com/tact-lang/tact-docs/issues)
